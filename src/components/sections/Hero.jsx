      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        >
          <div className="flex flex-wrap justify-center gap-2 mb-6">
            <Badge variant="success">100% KOSTENLOS</Badge>
            <Badge variant="info">PROPRIETÄRER ALGORITHMUS</Badge>
            <Badge variant="info">50+ LEGENDÄRE INVESTOREN</Badge>
          </div>

          <h1 className="text-5xl sm:text-6xl lg:text-7xl font-bold leading-tight">
            Erfahren Sie genau, wo{' '}
            <span className="text-gradient">Milliardäre</span>
            <br />
            investieren
          </h1>

          <p className="text-xl sm:text-2xl text-blueGray-400 max-w-3xl mx-auto">
            Entdecken Sie, welche Aktien die weltbesten Fondsmanager kaufen und verkaufen
            <span className="text-blueGray-300 font-medium"> bevor </span>
            der Markt reagiert.
          </p>

          <div className="flex flex-col sm:flex-row justify-center items-center gap-4 pt-4">
            <Button onClick={onGetAccess} className="text-lg px-8 py-4">
              Kostenlosen Sofortzugang erhalten
            </Button>
            <Button variant="secondary" className="text-lg px-8 py-4">
              <a href="#rankings" className="flex items-center">
                Top 50 Aktien anzeigen
